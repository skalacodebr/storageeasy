<!-- Modal Nova Unidade -->
<div class="modal fade" id="modalEditeUnidade" tabindex="-1" aria-labelledby="modalEditeUnidadeLabel" aria-hidden="true">
                ...
                <form>
                    ...
                    <div class="modal-nova-unidade-header border-bottom">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div>
                                <h4 class="fw-bold mb-0" id="modalEditeUnidadeLabel">Editar Unidade</h4>
                                <small class="text-muted">Preencha os dados para editar a unidade de armazenamento.</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-nova-unidade-footer">
                        ...
                        <button type="submit" class="btn btn-success rounded-3 px-4 fw-semibold">Editar Unidade</button>
                    </div>
                </form>
            </div>
        </div>
