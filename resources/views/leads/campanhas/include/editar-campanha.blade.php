...
<div class="modal fade" id="modalEditarCampanha" tabindex="-1" aria-labelledby="modalNovaCampanhaLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content p-2 px-md-3 py-md-2" style="border-radius: 18px; max-width:540px; margin:auto;">
            <div class="modal-header border-0 pb-0">
                <div>
                    <h5 class="modal-title fw-bold" id="modalNovaCampanhaLabel">Editar Campanha</h5>
                    <div class="text-muted" style="font-size:15px;">
                        Edite os dados da campanha.
                    </div>
                </div>
            ...
            <div class="modal-body pt-2">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="campanhaNome" placeholder="Ex: Black Friday 2024"
                            required>
                    </div>
                    <!-- Descrição -->
                    <div class="mb-3">
                        <label for="campanhaDescricao" class="form-label mb-1">Descrição *</label>
                        <textarea class="form-control" id="campanhaDescricao" placeholder="Descreva a campanha" rows="2"
                            required></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="campanhaData" placeholder="dd/mm/aaaa"
                                    required>
                    ...
                    <div class="mb-1">
                        ...
                        <textarea class="form-control" id="campanhaConteudo" rows="2"
                            placeholder="O editor de conteúdo será implementado aqui." readonly
                            style="background:#f6fafd; color:#89a; font-size:15px;"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer border-0 pt-0 pb-3">
                <button type="button" class="btn btn-outline-secondary px-4" data-bs-dismiss="modal">Cancelar</button>
                <button type="submit" class="btn btn-dark px-4 fw-semibold">Editar Campanha</button>
            </div>
        </div>
    </div>
</div>