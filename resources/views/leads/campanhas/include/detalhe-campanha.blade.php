...
<div class="modal fade" id="modalDetalheCampanha" tabindex="-1" aria-labelledby="modalDetalheCampanhaLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content p-2 px-md-3 py-md-2" style="border-radius: 18px; max-width:540px; margin:auto;">
            <div class="modal-header border-0 pb-0">
                <div>
                    <h5 class="modal-title fw-bold" id="modalDetalheCampanhaLabel">Detalhes da Campanha</h5>
                    <div class="text-muted" style="font-size:15px;">
                        Visualize os detalhes da campanha.
                    </div>
                </div>
