...
<div class="modal fade" id="modalNovaLocacao" tabindex="-1" aria-labelledby="modalNovaLocacaoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form>
                <div class="modal-nova-locacao-header border-bottom pb-3 pt-4 px-4">
                    <h4 class="fw-bold mb-1" id="modalNovaLocacaoLabel">Nova Locação</h4>
                    <div class="text-secondary" style="font-size:1rem;">
                        Preencha os dados para registrar uma nova locação.
                    </div>
                </div>
                ...
                <div class="modal-nova-locacao-footer pt-3 pb-4 px-4">
