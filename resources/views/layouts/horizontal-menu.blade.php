             ...
             <div class="collapse navbar-collapse" id="topnav-menu-content">
                 <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle arrow-none" href="/Dason-PHP" id="topnav-dashboard" role="button">
                             <i data-feather="home"></i><span data-key="t-dashboard"><?php echo $language['Dashboard'] ?> </span>
                         </a>
                     </li>
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                             ...
                             <span data-key="t-components"><?php echo $language['Elements'] ?> </span>
                                             ...
                                             <div class="row g-0">
                                                 ...
                                                 <div class="col-lg-5">
                                                     <div>
                                                         ...
                                                         <a href="ui-placeholders.php" class="dropdown-item" data-key="t-progress-bars"><?php echo $language['Placeholders'] ?> </a>
                         ...
                         <div class="dropdown-menu" aria-labelledby="topnav-more">
                             ...
                             <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                     <a href="auth-login.php" class="dropdown-item" data-key="t-login"><?php echo $language['Login'] ?> </a>
                                     <a href="auth-register.php" class="dropdown-item" data-key="t-register"><?php echo $language['Register'] ?> </a>
                                     <a href="auth-recoverpw.php" class="dropdown-item" data-key="t-recover-password"><?php echo $language['Recover_Password'] ?> </a>
                                     <a href="auth-lock-screen.php" class="dropdown-item" data-key="t-lock-screen"><?php echo $language['Lock_Screen'] ?> </a>
                                     <a href="auth-Logout.php" class="dropdown-item" data-key="t-Logout"><?php echo $language['Logout'] ?> </a>
