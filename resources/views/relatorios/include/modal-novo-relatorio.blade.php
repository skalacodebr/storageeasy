<div class="modal fade" id="modalNovoRelatorio" tabindex="-1" aria-labelledby="modalNovoRelatorioLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-relatorio">
            <div class="modal-relatorio-header modal-header border-0 pb-0">
                <div>
                    <h4 class="modal-relatorio-title modal-title" id="modalNovoRelatorioLabel">Programar Novo Relatório
                    </h4>
                    <div class="modal-relatorio-subtitle text-muted">
                        Configure os detalhes para a geração automática do seu novo relatório.
                    </div>
                </div>
